...
export default function ChooseRoleBox() {
  ...
  const roles: Role[] = [
    { key: "roles.student", desc: "roles.student_desc", value: "student", icon: "🎓" },
    { key: "roles.teacher", desc: "roles.teacher_desc", value: "teacher", icon: "📖" },
    { key: "roles.coordinator", desc: "roles.coordinator_desc", value: "coordinator", icon: "🏫" },
  ];
